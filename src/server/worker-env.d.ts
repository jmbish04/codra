/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/server/worker-env.d.ts` (hash: 572e19ee856af4e92a853a6ca2b5b933)
...
interface __BaseEnv_Env {
	...
	RepoAgent: DurableObjectNamespace<import("./index").RepoAgent>;
	Chat: DurableObjectNamespace<import("./index").Chat>;
	ReviewAgent: DurableObjectNamespace<import("./index").ReviewAgent>;
	GitHubLikeMCP: DurableObjectNamespace<import("./index").GitHubLikeMCP>;
	PrReviewStream: DurableObjectNamespace<import("./index").PrReviewStream>;
	JobsFeed: DurableObjectNamespace<import("./index").JobsFeed>;
