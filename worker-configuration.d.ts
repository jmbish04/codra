/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0a5d39c8b7709afe6951824cf5e0d2c3)
// Runtime types generated with workerd@1.20260730.1 2026-07-08 nodejs_compat
interface __BaseEnv_Env {
	APP_KV: KVNamespace;
	PROMPTS_KV: KVNamespace;
	PLANNING_ARTIFACTS: R2Bucket;
	DB: D1Database;
	REVIEW_ANALYTICS: AnalyticsEngineDataset;
	REVIEW_QUEUE: Queue;
	...
	cf_paid_account_id: SecretsStoreSecret;
	CLOUDFLARE_IMAGES_STREAM_TOKEN: SecretsStoreSecret;
	cf_paid_api_token: SecretsStoreSecret;
	WORKER_API_KEY: SecretsStoreSecret;
	AI_GATEWAY_TOKEN: SecretsStoreSecret;
	cf_free_api_token: SecretsStoreSecret;
	cf_free_account_id: SecretsStoreSecret;
	...
	CF_DLQ_ID: "";
	STANDARDIZATION_REPO: "jmbish04/core-github-standardization";
	AI_GATEWAY_ID: "codra";
	OPENCODE_TUNNEL_URL: "";
	...
	RepoAgent: DurableObjectNamespace<import("./src/server/index").RepoAgent>;
	Chat: DurableObjectNamespace<import("./src/server/index").Chat>;
	ReviewAgent: DurableObjectNamespace<import("./src/server/index").ReviewAgent>;
	GitHubLikeMCP: DurableObjectNamespace<import("./src/server/index").GitHubLikeMCP>;
	PrReviewStream: DurableObjectNamespace<import("./src/server/index").PrReviewStream>;
	JobsFeed: DurableObjectNamespace<import("./src/server/index").JobsFeed>;
	EDGRAPH: Fetcher /* core-github-api-edgraph */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "RepoAgent" | "Chat" | "ReviewAgent" | "GitHubLikeMCP" | "PrReviewStream" | "JobsFeed";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "AUTH_CALLBACK_URL" | "BOT_USERNAME" | "GITHUB_APP_SLUG" | "DASHBOARD_ALLOWED_USERS" | "ENVIRONMENT" | "CF_DLQ_ID" | "STANDARDIZATION_REPO" | "AI_GATEWAY_ID" | "OPENCODE_TUNNEL_URL" | "APP_PRIVATE_KEY" | "LLM_CONFIG_ENCRYPTION_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_APP_ID">> {}
}
declare module "*.md" {
	const value: string;
