/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 17fb357e1c1f06429df229248dd25deb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "AUTH_CALLBACK_URL" | "BOT_USERNAME" | "GITHUB_APP_SLUG" | "DASHBOARD_ALLOWED_USERS" | "ENVIRONMENT" | "CF_DLQ_ID" | "STANDARDIZATION_REPO" | "AI_GATEWAY_ID" | "APP_PRIVATE_KEY" | "LLM_CONFIG_ENCRYPTION_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_APP_ID">> {}
}
declare module "*.md" {
	const value: string;
